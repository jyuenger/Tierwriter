...
- Optional: Five decorative top plates, one for each row (AI files for lasercutting in the Plates/Tops folder; will fit MX or Alps build)
- Optional: Base plate (AI file for lasercutting in the Plates/Bottom Plate folder)
